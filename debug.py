...
#        >>> debug = Debug(configuration, serializer, logger, function_mapping)
#
#        >>> @debug.decorate
#        ... def add(x, y):
#        ...     return x + y
...
#
#        >>> result = add(3, 4)
#        Log file path: logs/__main__.add.log
#        Log directory: logs
#        Item type: <class 'int'>
#        Item type: <class 'int'>
#        Item type: <class 'dict'>
#        <__main__.add.add>CALL
#        3, 4
#        {}
#        Item type: <class 'int'>
#        </__main__.add.add>RETURN 7
#        >>> result
#        7
#
#        >>> @debug.decorate
...
#
#        >>> result = multiply(2, 3)
#        Log file path: logs/__main__.multiply.log
#        Log directory: logs
#        Item type: <class 'int'>
#        Item type: <class 'int'>
#        Item type: <class 'dict'>
#        <__main__.multiply.multiply>CALL
#        2, 3
#        {}
#        Item type: <class 'int'>
#        </__main__.multiply.multiply>RETURN 6
#        >>> result
#        6
#
#        >>> result = multiply(4, 5)
...
#        {}
#        Item type: <class 'int'>
#        </__main__.multiply.multiply>RETURN 20
#        >>> result
#        20
#
#        >>> result = multiply(6, 7)
...
#        """
#        Formats the console log output based on the data type.
#
#        >>> data = (3, "hello")
#        >>> debug = Debug(Configuration(), Serializer(), Logger(), FunctionMapping())
#        >>> formatted_log = debug._formatConsoleLog(data)
#        Item type: <class 'int'>
#        Item type: <class 'str'>
#        >>> formatted_log
#        '3, hello'
